...
const CreateBlog = () => {
  ...
  return (
    <div>
      ...
      <button
        onClick={goBack}
        className="flex items-center space-x-1 px-10 font-bold"
      >
        <BiArrowBack size={24} />
        <span>Go Back</span>
      </button>
      {isSubmitting && (
        <div className="text-blue-500 absolute top-10 left-1/2">Loading...</div>
      )}
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            ...
            className={`w-full bg-blue-500 text-white px-4 py-2 rounded ${
              isSubmitting ? "bg-blue-400 cursor-not-allowed" : null
            }`}
          >
            Submit
          </button>
